                    ...
                    <div className="modal-body">
                        {
                            cryptoData.map((value, index) => (
                                <div key={index} className="alert alert-primary-data-cryptos mr-0 mr-md-3 mr-lg-5"
                                     role="alert">
                                    <div className="row">
                                        ...
                                        <div className="d-flex justify-content-center">
                                            ...
                                            <div
                                                className="col-7 col-sm-8 col-md-8 col-lg-9 col-xl-9 d-flex justify-content-start">
